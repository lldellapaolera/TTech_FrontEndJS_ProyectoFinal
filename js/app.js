   ...
   const productos = {
    AlberdiConcretewhite1: { 
        nombre: 'Alberdi Concrete white 1', 
        precio: 28939.9, 
        stock: 15,
        descuento: 0.1  // 10% de descuento
    },
    AlberdiConcretewhite2: { 
        nombre: 'Alberdi Concrete white 2', 
        precio: 28939.9, 
        stock: 10,
        descuento: 0.05  // 5% de descuento
    },
    AlberdiConcretewhite3: { 
        nombre: 'Alberdi Concrete white 3', 
        precio: 28939.9, 
        stock: 9,
        descuento: 0  // Sin descuento
    },
    AlberdiConcretewhite4: { 
        nombre: 'Alberdi Concrete white 4', 
        precio: 28939.9, 
        stock: 17,
        descuento: 0.05  // 5% de descuento
    },
    AlberdiConcretewhite5: { 
        nombre: 'Alberdi Concrete white 5', 
        precio: 28939.9, 
        stock: 23,
        descuento: 0.05  // 5% de descuento
    },
    AlberdiConcretewhite6: { 
        nombre: 'Alberdi Concrete white 6', 
        precio: 28939.9, 
        stock: 20,
        descuento: 0.05  // 5% de descuento
    }
